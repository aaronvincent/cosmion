subroutine fehlfull_n2 ( f, neqn, y, t, h, yp, f1, f2, f3, f4, f5, s )
!AV: renamed fehlfull_n2 this is really stupid, I have a separate function for
!every integrand number of equations, becaues of the interface block
!*****************************************************************************80
!
...
subroutine rkf45full_n2 ( f, neqn, y, yp, t, tout, relerr, abserr, flag )
...
!
      ...
      call fehlfull_n2 ( f, neqn, y, t, h, yp, f1, f2, f3, f4, f5, f1 )
      nfe = nfe + 5
